# Figure 1. Mean annual production (tonnes) for the thirty most extensively farmed fish species in net-pen systems in Marine Ecoregions of the World by introduction status: native (top panel) and non-native (bottom panel).
...
# read data-------------
production_dat_long <- st_read("production_dat_long.geojson")
score_data_sf <-  st_read("score_data_sf.geojson")
std_scores <- read_csv('std_scores.csv')
